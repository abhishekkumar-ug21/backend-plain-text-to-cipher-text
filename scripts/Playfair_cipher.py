...
# # Ensure there is an argument for the plaintext
# if len(sys.argv) < 2:
#     print("Error: No plaintext provided.")
#     sys.exit(1)

# # Read plaintext from command line arguments
...
#     plaintext = sys.argv[1] if len(sys.argv) > 1 else input("Enter plaintext to encrypt: ")
#     try:
#         cipher_text = encrypt(plaintext)
#         print(cipher_text)
